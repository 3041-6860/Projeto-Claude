...
import { listarDocumentos, salvarDocumento, removerDocumento, formatarTamanho } from "@/lib/datajuri/documentos-storage";
import type { Documento, TipoDocumento } from "@/lib/datajuri/documentos-storage";
import { listarProcessos } from "@/lib/datajuri/processos-storage";
import { listarAdvogados } from "@/lib/datajuri/equipe-storage";
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    {doc.processoNumero && (
                      <>
                        ...
                        <Link href={`/datajuri/processos/${doc.processoId}`}
