      ...
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-sm">
        <div className="text-center mb-6">
          <div className="flex justify-center mb-3">
            <img src="/logo.png" alt="Grupo Inove Prime" className="h-16 w-auto object-contain" />
          </div>
        ...
        <form action={action} className="space-y-3">
          <div>
            <label className="text-[11px] font-semibold block mb-1" style={{ color: 'var(--navy)' }}>E-mail</label>
            <input
              name="email"
              type="email"
