...
import { listarAudiencias } from "@/lib/agenda-storage";
...
import type { Audiencia } from "@/lib/agenda-storage";
import { formatDate, formatCurrency, diasRestantes } from "@/lib/utils";
import {
...
import { DEFAULT_WIDGETS, WIDGETS_STORAGE_KEY, type WidgetKey } from "@/lib/dashboard-widgets";
    ...
    <div className="space-y-4 max-w-[1200px]">
      ...
      {(w("lista_prazos") || w("lista_audiencias")) && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {w("lista_prazos") && (
            <SectionCard title="Prazos Próximos" icon={AlertTriangle} href="/prazos" linkLabel="Ver todos">
          ...
          {w("lista_audiencias") && (
            <SectionCard title="Próximas Audiências" icon={Calendar} href="/agenda" linkLabel="Ver agenda">
      ...
      {(w("lista_processos") || w("lista_tarefas")) && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {w("lista_processos") && (
            <SectionCard title="Processos Recentes" icon={FolderOpen} href="/processos" linkLabel="Ver todos">
          ...
          {w("lista_tarefas") && (
            <SectionCard title="Tarefas Prioritárias" icon={CheckSquare} href="/tarefas" linkLabel="Ver todas">
