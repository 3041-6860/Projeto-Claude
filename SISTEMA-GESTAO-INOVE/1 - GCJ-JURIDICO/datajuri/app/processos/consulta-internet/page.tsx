...
import { listarProcessos, salvarProcesso, PROCESSOS_STORAGE_KEY } from "@/lib/processos-storage";
    ...
    <div className="space-y-5 max-w-4xl">
                  ...
                  <tr key={cfg.id} className="border-b last:border-0 transition-colors hover:bg-gray-50"
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <Link href={`/processos?q=${cfg.numero}`}>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1.5">
                        ...
                        <Link href={`/processos?q=${cfg.numero}`} title="Ver processo">
                        ...
                        <Link href={`/processos/novo?numero=${cfg.numero}`} title="Abrir no DataJud">
                          <button type="button" className="p-1.5 rounded-lg transition-colors hover:bg-gray-100">
      ...
      <div className="flex items-start gap-2.5 px-4 py-3 rounded-xl" style={{ background: "#f8fafc", border: "1px solid var(--border)" }}>
        ...
        <p className="text-[11px]" style={{ color: "var(--text-muted)" }}>
          ...
          <Link href="/admin/configuracoes" className="underline" style={{ color: "var(--gcj-red)" }}>
            Configurações → Processos
          </Link>.
          Para adicionar um processo já com todos os dados importados, use{" "}
          <Link href="/processos/novo" className="underline" style={{ color: "var(--gcj-red)" }}>
