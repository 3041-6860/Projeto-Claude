...
import { listarProcessos, salvarProcesso, removerProcesso } from "@/lib/processos-storage";
import type { Processo, StatusProcesso } from "@/lib/mock-data";
    ...
    <div className="space-y-4 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          {/* Link para cliente */}
          <Link href={`/clientes/${encodeURIComponent(processo.cliente)}`}>
